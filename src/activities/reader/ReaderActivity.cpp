...
void ReaderActivity::onGoToEpubReader(std::unique_ptr<Epub> epub) {
  ...
  activityManager.replaceActivity(std::make_unique<RsvpReaderActivity>(renderer, mappedInput, std::move(epub)));
}
...
void ReaderActivity::onGoToTxtReader(std::unique_ptr<Txt> txt) {
  ...
  activityManager.replaceActivity(std::make_unique<RsvpReaderActivity>(renderer, mappedInput, std::move(txt)));
}
